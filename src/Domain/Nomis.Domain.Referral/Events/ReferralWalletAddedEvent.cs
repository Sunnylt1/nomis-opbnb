// ------------------------------------------------------------------------------------------------------
// <copyright file="ReferralWalletAddedEvent.cs" company="Nomis">
...
{
    /// <summary>
    /// Add referral wallet domain event.
    /// </summary>
    public class ReferralWalletAddedEvent :
        DomainEvent<ReferralWallet>
    {
        /// <summary>
        /// Initialize <see cref="ReferralWalletAddedEvent"/>.
        /// </summary>
        public ReferralWalletAddedEvent()
