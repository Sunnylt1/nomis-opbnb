// ------------------------------------------------------------------------------------------------------
// <copyright file="ReferralDataAddedEvent.cs" company="Nomis">
...
{
    /// <summary>
    /// Add referral data domain event.
    /// </summary>
    public class ReferralDataAddedEvent :
        DomainEvent<ReferralData>
    {
        /// <summary>
        /// Initialize <see cref="ReferralDataAddedEvent"/>.
        /// </summary>
        public ReferralDataAddedEvent()
