// ------------------------------------------------------------------------------------------------------
// <copyright file="RewardDataAddedEvent.cs" company="Nomis">
...
{
    /// <summary>
    /// Add reward data domain event.
    /// </summary>
    public class RewardDataAddedEvent :
        DomainEvent<RewardData>
    {
        /// <summary>
        /// Initialize <see cref="RewardDataAddedEvent"/>.
        /// </summary>
        public RewardDataAddedEvent()
